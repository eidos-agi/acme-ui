// Eidos UI mock AI v2 — everything v1 speaks, plus APPROVAL-GATED tools:
// a tool_use may carry {approval: "required", approval_id, danger}. The
// stream then BLOCKS until the client calls handle.decide(approval_id,
// approved) — true resumes with the tool result, false takes the denied
// branch. v1 stays frozen; load one mock per page.
...
window.MockAI.v2 = (function () {
  ...
  return v1;   // factory; assigned as MockAI.v2 below
})();
